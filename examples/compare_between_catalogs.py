...
chosen = chosen[
    (chosen["reference_mass_ratio"] < 4.1)
...
wf_gra = gra.Waveform_GRA(
    path=f"/ligo/home/ligo.org/rossella.gamba/ali_data/{gra_id}",
    cut_U=100,
...
for id in sxs_id:
    ...
    for total_mass in track(numpy.linspace(30, 300, 10)):
        ...
        print(
            f"M={total_mass} Msun, mismatch={Mtch.mismatch}, f0={f_mm * 1.5 / (total_mass * Msun)}"
        )
