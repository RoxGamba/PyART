...
def write_metadata_from_sxs(out_filename, resolution, metadata, start_time, peak_time, l_max):
...
def convert_simulation(sxs_data_path, resolution, modes, out_path, 
                       truncation_time=None):
...
if __name__ == "__main__":
   convert_simulation(args.sxs_data, args.resolution, modes, args.out_path, args.truncation_time)    
