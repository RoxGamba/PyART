...
class Waveform_SACRA(Waveform):
    ...
    def load_metadata(self):
        ...
        m2 = self.info["M_NS"]
        m1 = M - m2
        S1 = np.array([0.0, 0.0, self.info["a_BH"] * m1 * m1])
        ...
        metadata = {
            ...
            "pos1": None,
            "pos2": None,
            "f0v": np.array([0.0, 0.0, f0]),
            "f0": f0,
            "Mf": self.info["Xf"],
            "af": self.info["af"],
            "afv": np.array([0.0, 0.0, self.info["af"]]),
            "scat_angle": None,
        }
    ...
    def load_hlm(self):
        ...
        if (
            X is None
        ):  # if fname not found in 2-piecewise polytrops, search in 4-piecewise
